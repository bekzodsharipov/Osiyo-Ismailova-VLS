document.addEventListener("DOMContentLoaded", (function () {
    const e = document.getElementById("registrationForm2")
      ...
      , n = document.getElementById("phone2")
      , l = document.getElementById("nameError2")
      , i = document.getElementById("phoneError2")
      , a = document.getElementById("errorMessage2")
      , h = document.getElementById("submitBtn2")
      , c = document.getElementById("selectedCountry2")
      , r = document.getElementById("selectedCountryCode2")
      , d = document.getElementById("countryDropdown2")
      , o = document.getElementById("dropdownIcon2")
      , g = [{
        name: "uz O‘zbekiston",
         code: "+998",
      }, {
        ...
        name: "🇮🇴 Britan Hind okeani hududi",
        code: "+246"
      }, {
        name: "🇻🇬 Britan Virgin orollari",
        code: "+1"
      }, {
        name: "🇧🇳 Bruney",
        code: "+673"
      ...
      , m = {
        ...
        "+93": {
          ...
          format: function (e) {
            let t = "+93 ";
            return e.length > 0 && (t += e.slice(0, Math.min(2, e.length))),
        ...
        "+213": {
          ...
          format: function (e) {
            let t = "+213 ";
            return e.length > 0 && (t += e.slice(0, Math.min(1, e.length))),
        ...
        "+1": {
          ...
          format: function (e) {
            let t = "+1 ";
            return e.length > 0 && (t += e.slice(0, Math.min(3, e.length))),
        ...
        "+973": {
          ...
          format: function (e) {
            let t = "+973 ";
            return e.length > 0 && (t += e.slice(0, Math.min(4, e.length))),
        ...
        "+686": {
          ...
          format: function (e) {
            let t = "+686 ";
            return e.length > 0 && (t += e.slice(0, Math.min(5, e.length))),
              t
          },
          validate: function (e) {
    ...
    function u(e) {
      ...
      o.innerHTML = '<polyline points="6 9 12 15 18 9"></polyline>';
    }
  
    c.addEventListener("click", (function () {
      "block" === d.style.display ? (d.style.display = "none",
        o.innerHTML = '<polyline points="6 9 12 15 18 9"></polyline>') : (d.innerHTML = "",
          g.forEach((e => {
          ...
          o.innerHTML = '<polyline points="18 15 12 9 6 15"></polyline>')
    }
    )),
      document.addEventListener("click", (function (e) {
        c.contains(e.target) || d.contains(e.target) || (d.style.display = "none",
          o.innerHTML = '<polyline points="6 9 12 15 18 9"></polyline>')
      }
      )),
      n.addEventListener("input", (function (e) {
        ...
        }(e.target.value.replace(s, "").trim(), s);
        n.value = t,
          i.style.display = "none"
      }
      )),
      ...
      e.addEventListener("submit", (async function (e) {
        ...
        if (l.style.display = "none",
          ...
          !t.value.trim())
          return void (l.style.display = "block");
        if (c = n.value,
          !(m[s] || m["+998"]).validate(c))
          return void (i.style.display = "block");
        var c;
        h.textContent = "YUBORILMOQDA...",
          h.disabled = !0;
        const r = new FormData;
        r.append("Ism", t.value.trim()),
          r.append("Telefon raqam", n.value),
          r.append("Royhatdan o'tgan vaqti", function () {
            const e = new Date;
            return `${String(e.getDate()).padStart(2, "0")}-${String(e.getMonth() + 1).padStart(2, "0")}-${e.getFullYear()}, ${String(e.getHours()).padStart(2, "0")}:${String(e.getMinutes()).padStart(2, "0")}`
          }());
        const d = {
          name: t.value.trim(),
          phone: n.value,
